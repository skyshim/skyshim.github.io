        ...
        const response = await fetch('https://skyshim-github-io.onrender.com/api/openai', {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    ...
                    { role: 'user', content: `provide 5 example sentences and korean meanings using the word: ${word}. Do not show index or change singular/plural and tense. Comply with the form: "example sentence.|korean meanings."`},
                ],
            }),
        });
